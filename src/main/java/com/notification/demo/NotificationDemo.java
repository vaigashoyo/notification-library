    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Notification smsNotification = Notification.create(
                    smsRecipient, null, "Tu código de verificación es: 123456", Channel.SMS);
            ...
            Recipient pushRecipient = new Recipient("device_token_abc123def456", "María López", Channel.PUSH);
            Notification pushNotification = Notification.create(
                    pushRecipient, "Nueva oferta", "Descuento del 50% en tu próxima compra", Channel.PUSH);
            ...
            List<Notification> batch = List.of(
                    Notification.create(
                            new Recipient("+1987654321", "Carlos García", Channel.SMS),
                            null, "Recordatorio: tu cita es mañana a las 10:00", Channel.SMS),
                    Notification.create(
                            new Recipient("+1555666777", "Ana Martínez", Channel.SMS),
                            null, "Tu pedido ha sido enviado", Channel.SMS),
                    Notification.create(
                            new Recipient("device_token_xyz789abc012", "Pedro Sánchez", Channel.PUSH),
            ...
            try {
                ...
                Notification badNotification = Notification.create(
                        badRecipient, null, "Test message", Channel.SMS);
